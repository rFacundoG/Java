...
/*Ejercicio 4:
Escriba un programa para realizar otra función que invierta una lista, similar al ejercicioa nterior, pero en lugar de devolver una nueva, modifique la lista dada para invertirla, sin usar listas auxiliares.*/
