...
/*Ejercicio 1:
Escriba un programa que solicite al usuario un valor entero para establecer el tamaño de un arreglo de numeros enteros. Luego utilice ese valor para crear el arreglo y posteriormente solicitar al usuario que ingrese cada uno de los valores para completar el arreglo. Finalmente, imprima por pantalla la lista de valores ingresados por el usuario en:
    ...
    d) Un lista de todos los valores que se encuentran ubicados en posiciones impares en el arreglo.
*/
...
public class Arreglos01 {
    public static void main(String[] args) {
        ...
        // c) Imprimir todos los numeros pares
